...
const PWA_HEAD = `  <link rel="manifest" href="/manifest.webmanifest" ${PWA_HEAD_MARKER}>
  ...
  <link rel="stylesheet" href="/styles/app-header-controls.css?v=20260923-notification-read-v6">
  <script src="/pwa-runtime.js" defer></script>
  <script src="/js/modules/app-header-controls.js?v=20260923-notification-read-v6" defer></script>
  ...
  <script src="/js/modules/notification-center.js?v=20260923-notification-read-v6" defer></script>`;
