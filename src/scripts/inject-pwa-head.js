...
const PWA_HEAD = `  <link rel="manifest" href="/manifest.webmanifest" ${PWA_HEAD_MARKER}>
  ...
  <link rel="stylesheet" href="/styles/app-header-controls.css?v=20260923-notification-read-v5">
  <script src="/pwa-runtime.js" defer></script>
  <script src="/js/modules/app-header-controls.js?v=20260923-notification-read-v5" defer></script>
  <script src="/repositories/notification-outbox-repository.js?v=20260923-notification-read-v5" defer></script>
  <script src="/js/modules/notification-domain-hooks.js?v=20260923-notification-read-v5" defer></script>
  <script src="/js/modules/notification-push.js?v=20260923-notification-read-v5" defer></script>
  <script src="/js/modules/notification-center.js?v=20260923-notification-read-v5" defer></script>`;
