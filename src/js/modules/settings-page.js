(function initSettingsPage(scope) {
  ...
  function renderShell(root) {
    root.innerHTML = `<div class="settings-page"><header class="settings-header"><div class="ide-module-kicker">Administração · Configurações</div><h1>Configurações</h1><p>Parametrize estruturas administrativas utilizadas pelo IDE Music.</p></header><div class="settings-layout"><div id="settings-content"></div></div></div>`;
