(function initSchedulesPage(scope) {
  ...
  function renderEditorView() {
    ...
    const emptySlots=`<div class="ide-empty-state schedule-empty"><strong>Nenhuma função adicionada</strong><span>${editable?'Adicione as funções necessárias para este evento.':'Esta escala ainda não possui funções definidas.'}</span></div>`;
